...
# This step is different than usual
surrogate_structural = StructuralGp_Torch(myGP)
print(surrogate_structural.parameter_names)
nlme_surrogate = NLMEModel_Torch(
    surrogate_structural,
    patients_df,
    init_log_MI,
    init_log_PDU,
    init_res_var,
...
# This is where we use another optimizer
optimizer = PySAEM_Torch(
    nlme_surrogate,
    observations_df,
    mcmc_burn_in=1,
